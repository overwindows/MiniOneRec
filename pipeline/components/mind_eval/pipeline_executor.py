...
使用方法:
    python pipeline_executor.py --config config_minionerec_eval.json --mount-dir /mnt/... --model-path path/to/checkpoint ...
"""
...
def main():
    ...
    parser.add_argument("--model-path", help="模型checkpoint路径（相对于挂载路径）")
    ...
    if args.mount_dir and args.model_path:
        ...
        cli_variables['model_path'] = args.model_path
