...
# =========================
# DOCA Listwise SFT Training Script
# =========================
# Usage:
#   bash scripts/sft_doca_listwise_ds.sh
#
# Key environment variables (override defaults):
#   MODEL_PATH, DATA_ROOT, BATCH_SIZE, MICRO_BATCH_SIZE,
#   LEARNING_RATE, CUTOFF_LEN, NUM_EPOCHS, MAX_CANDIDATES
...
OUTPUT_NAME="sft_doca_listwise_${MODEL_BASENAME}_bs${BATCH_SIZE}_ep${NUM_EPOCHS}_cand${MAX_CANDIDATES}"
