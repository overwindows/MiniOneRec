...
def train(
    ...
    item_meta_path: str = "",
    # deepspeed params
    deepspeed_config: str = "",  # path to deepspeed config file
):
    set_seed(seed)
    ...
    try:
        import flash_attn
        use_flash_attn = True
        print("Flash Attention 2 detected, will use it for memory efficiency")
    except ImportError:
    ...
    # Store original vocab size for gradient masking
